...
<body>
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="{{ route('services') }}" target="_blank">Register</a></li>
                        <li><a href="{{ route('services') }}" target="_blank">Login</a></li>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              ...
              <p>A comprehensive tool to efficiently manage and organize your research references, including support for importing, exporting, and formatting citations in multiple styles like APA, MLA, and BibTeX.
              </p>
              <div class="main-button">
                <a href="#">Read More</a>
              </div>
        ...
        <div class="col-lg-4 col-md-6">
          <div class="service-item">
            ...
            <div class="main-content">
              ...
              <p>Stay on top of your submissions with a built-in tracker for academic publications. Monitor the status of your work across journals and conferences, including deadlines, reviews, and updates.
              </p>
              <div class="main-button">
                <a href="#">Read More</a>
              </div>
  ...
  <footer>
    <div class="container">
      <div class="col-lg-12">
        <p>Copyright © 2024 Scholar Organization. All rights reserved. Designed By Mohamed Doukkani with ❤️</p>
      </div>
    </div>
  </footer>
